...
// ── SECURITY: Short-lived sessions ───────────────────────────────────────────
// Sessions expire after 24 hours. Combined with httpOnly + SameSite=Lax cookies
// this drastically reduces the window for stolen-token abuse.
export const SESSION_MAX_AGE_MS = 1000 * 60 * 60 * 24; // 24 hours

// Increment this to instantly invalidate ALL existing sessions (nuclear option).
// Useful after a secret rotation or if a breach is suspected.
